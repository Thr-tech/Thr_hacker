...
def banner_logo():
    ...
    os.system('cls' if os.name == 'nt' else 'clear') # Coded by GMA

    print(Panel(f"""[bold red]●[bold yellow] ●[bold read] ●



[bold pink]   _____  _____  ______ __  __ _____ _    _ __  __ 

[bold pink]  |  __ \|  __ \|  ____|  \/  |_   _| |  | |  \/  |

[bold pink]  | |__) | |__) | |__  | \  / | | | | |  | | \  / |

[bold pink]  |  ___/|  _  /|  __| | |\/| | | | | |  | | |\/| |

[bold green]  | |    | | \ \| |____| |  | |_| |_| |__| | |  | |

[bold green]  |_|    |_|  \_\______|_|  |_|_____|\____/|_|  |_|





\t   [bold red]Coded by Thr-tech

[bold blue][[bold white]•[bold blue]] [bold green]Au :  Thr-tech

[bold blue][[bold white]•[bold blue]][bold green]Github :  Thr-tech-404

[bold blue][[bold white]•[bold blue]][bold green]Insta :  Thr-tech1232
